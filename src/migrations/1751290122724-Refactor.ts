...
export class Refactor1751290122724 implements MigrationInterface {
  name = 'Refactor1751290122724';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."documents_document_status_enum" AS ENUM('pending', 'processing', 'completed', 'failed')`,
    );
    await queryRunner.query(
      `CREATE TABLE "documents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "is_active" boolean NOT NULL DEFAULT true, "is_deleted" boolean NOT NULL DEFAULT false, "deleted_at" TIMESTAMP, "title" character varying(255) NOT NULL, "description" text, "file_name" character varying(255) NOT NULL, "file_path" character varying(255) NOT NULL, "mime_type" text NOT NULL, "size" integer NOT NULL, "document_status" "public"."documents_document_status_enum" NOT NULL DEFAULT 'pending', "user_id" uuid NOT NULL, CONSTRAINT "PK_ac51aa5181ee2036f5ca482857c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_documents_created_at" ON "documents" ("created_at") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_documents_user_status" ON "documents" ("user_id", "document_status") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."idx_documents_user_status"`);
    await queryRunner.query(`DROP INDEX "public"."idx_documents_created_at"`);
    await queryRunner.query(`DROP TABLE "documents"`);
    await queryRunner.query(
      `DROP TYPE "public"."documents_document_status_enum"`,
    );
  }
}
